...
export class Sidebar {
  readonly navItems = [
    ...
    },
    {
      label: 'Usuarios',
      route: '/users',
      icon: 'M18 7.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm9.75 9.75a.75.75 0 0 0 .75-.75 4.5 4.5 0 0 0-4.5-4.5h-6a4.5 4.5 0 0 0-4.5 4.5.75.75 0 0 0 .75.75h13.5Z',
    },
    {
      label: 'Movimientos',
      route: '/movements',
